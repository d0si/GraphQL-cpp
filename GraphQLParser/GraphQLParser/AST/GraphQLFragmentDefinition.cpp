...
namespace GraphQLParser {
	namespace AST {
		...
		GraphQLFragmentDefinition::GraphQLFragmentDefinition(GraphQLName name, GraphQLNamedType type_condition, std::vector<GraphQLDirective> directives, GraphQLSelectionSet selection_set)
